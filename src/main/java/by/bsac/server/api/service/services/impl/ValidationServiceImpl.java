...
public class ValidationServiceImpl implements IValidationService {
  ...
  public void validateRecord(Record record, boolean withId) throws ServiceValidationException {
    ...
    Classroom classroom = record.getClassroomByIdClassroom();
    validateClassroom(classroom, true);

    Group group = record.getGroupByIdGroup();
    validateGroup(group, true);

    Lecturer lecturer = record.getLecturerByIdLecturer();
    validateLecturer(lecturer, true);

    Subject subject = record.getSubjectByIdSubject();
    validateSubject(subject, true);

    SubjectFor subjectFor = record.getSubjectForByIdSubjectFor();
    ...
    SubjectType subjectType = record.getSubjectTypeByIdSubjectType();
...
//    String name = classroom.getNumber();
//    if (Checker.isNameInvalid(name)) {
...
//    }
  ...
  public void validateLecturer(Lecturer lecturer, boolean withId)
    ...
    Chair chair = lecturer.getChairByIdChair();
  ...
  public void validateGroup(Group group, boolean withId) throws ServiceValidationException {
    ...
    Faculty faculty = group.getFacultyByIdFaculty();
    validateFaculty(faculty, true);
    Flow flow = group.getFlowByIdFlow();
